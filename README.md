...
- 🧋 **道地台灣小吃**：珍珠奶茶、黃金地瓜球、酥脆臭豆腐、香酥雞排、炭香烤玉米。
- 🏮 **五大夜市巡禮**：
...
第五種食物已由蚵仔煎改為烤玉米，正式遊戲與教學顯示一致。原始 PNG 保留；遊戲使用統一 256×256 的透明 WebP，五種四消小圖也已備妥。雞排與地瓜球四消圖的假棋盤背景已去除，高解析去背衍生檔另存於 `assets/images/cutouts/`。

可用 `python optimize_assets.py` 重建（需要 Pillow）。素材尺寸、來源雜湊、深淺背景與 40px 縮圖預覽見 [素材檢查說明](tools/asset-review/README.md)。直線消除與 T／L 型章魚燒的新規則尚未接入。
